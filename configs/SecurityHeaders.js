...
const ContentSecurityPolicy = `
  ...
  style-src 'self' 'unsafe-inline' 'unsafe-eval' *.givingloop.org givingloop.org fonts.googleapis.com fonts.googleapis.com wchat.eu.freshchat.com *.usetiful.com usetiful.com;
  img-src * data:;
