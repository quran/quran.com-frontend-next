/**
 * SSR-enabled version of StudyModeLessonsTab
 *
...
interface StudyModeLessonsTabSSRProps {
  chapterId: string;
  verseNumber: string;
...
const StudyModeLessonsTabSSR: React.FC<StudyModeLessonsTabSSRProps> = ({
  chapterId,
  verseNumber,
  locale,
}) => {
...
export default StudyModeLessonsTabSSR;
