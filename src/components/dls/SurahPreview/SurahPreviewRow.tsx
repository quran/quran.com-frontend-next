...
import ChapterIconContainer, { ChapterIconsSize } from '@/components/chapters/ChapterIcon/ChapterIconContainer';
...
const SurahPreviewRow = ({
	...
	const localizedSurahNumber = useMemo(() => toLocalizedNumber(surahNumber, lang), [surahNumber, lang]);
		...
		return (
			<div className={styles.container}>
				<div className={styles.left}>
					...
					<ChapterIconContainer chapterId={chapterId.toString()} hasSurahPrefix={false} size={ChapterIconsSize.Large} />
				</div>
