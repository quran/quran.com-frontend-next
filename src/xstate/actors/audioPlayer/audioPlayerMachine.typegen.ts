...
export interface Typegen0 {
  ...
  eventsCausingActions: {
    ...
    exitRadio: 'CONFIRM_PLAY_MISMATCHED_SURAH' | 'PLAY_AYAH' | 'PLAY_SURAH' | 'SET_REPEAT_SETTING';
    ...
    setAudioPlayerCurrentTime:
      ...
      | 'done.invoke.fetchReciter'
      | 'done.invoke.fetchRepeatData';
    setAudioPlayerSource: 'done.invoke.fetchReciter' | 'done.invoke.fetchRepeatData';
