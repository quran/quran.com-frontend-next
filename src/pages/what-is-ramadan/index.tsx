        ...
        {lang === 'ar' ? (
          ...
          <div className={classNames(pageStyles.container, styles.contentPage)} dir="ltr">
              ...
              <div className={styles.subSection}>
                <div>
                  <i>
                    ...
                    wrong. So any one of you who is present that month should fast, and anyone who
                    is ill or on a journey should make up for the lost days by fasting on other days
            ...
            <div className={styles.subSection}>
              ...
              <div>
                We invite you to take the first step on this journey. Explore Quran.com to
                experience the Quran for yourself. Listen to its recitation, read its meaning, and
